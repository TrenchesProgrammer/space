...
const Navbar = () => {
  ...
  return (
    ...
    >
      ...
      <div className="hidden justify-between md:flex gap-6 p-8 md:p-0 md:pl-25 md:pr-8 pl-25 bg-white/5 relative h-[75px] w-[650px] backdrop-blur-2xl shadow-lg items-center  ">
