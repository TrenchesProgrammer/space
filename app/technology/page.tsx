...
const Technology = () => {
  ...
  return (
    <div className="bg-technology-mobile flex flex-col  md:bg-technology-tablet lg:bg-technology-desktop bg-cover h-[100dvh] w-[100dvw]">
      <Navbar />
      <p className={`${barlowCondensed.className} tracking-widest`}><span className="text-bold text-white/25">03</span> SPACE LAUNCH 101</p>
      <div className="flex flex-1 flex-col lg:flex-row-reverse gap-3 lg:pt-10 lg:pl-10 pb-10">
          ...
          <div className="flex justify-center items-center lg:h-full lg:w-[55%] lg:flex-row">
